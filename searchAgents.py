        ...
        for action in [Directions.NORTH, Directions.SOUTH, Directions.EAST, Directions.WEST]:
            ...
            if not self.walls[nextx][nexty]:
                ...
                if nextPosition in cornersLeft:
                    cornersLeftList = list(cornersLeft)
                    for pos, corner in enumerate(cornersLeftList):
                        if corner == nextPosition:
                            cornersLeftList = cornersLeftList[:pos] + cornersLeftList[pos + 1:]
                            cornersLeft = tuple(cornersLeftList)
